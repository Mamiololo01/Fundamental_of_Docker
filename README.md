...
<img width="1163" alt="Screenshot 2023-05-25 at 01 57 20" src="https://github.com/Mamiololo01/Fundamentals_of_Docker/assets/67044030/a3e82edc-e1d1-4bc5-99a7-8dc3aedb6877">
		...
		 
Removing dangling images, stopped containers, dangling build cache and networks not used. Remove all unused containers, networks, images (both dangling and unreferenced), and optionally, volumes.
